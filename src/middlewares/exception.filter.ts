...
export class ExceptionsFilter implements ExceptionFilter {
        ...
        let errorMessage: any = exception instanceof HttpException ? exception.getResponse() : exception.message;
        ...
        if (exception instanceof CommonException) {
            errorMessage = exception.errorMessage ? exception.errorMessage : ErrorMessages.getMessage(exception.errorCode);
        }
